 ...
 */
public class FragmentFinshtask extends Fragment{
...
//        });
    ...
    public static class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>
    {
        ...
        {
            // 给ViewHolder设置布局文件
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.taskfinsh_list_item, viewGroup, false);
            //设置点击效果
