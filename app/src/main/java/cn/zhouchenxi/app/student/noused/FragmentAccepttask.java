 ...
 */
public class FragmentAccepttask extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView rv = (RecyclerView)rootview. findViewById(R.id.rl_recyclerview_refresh);
...
//        });
    ...
    public static class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>
    {
        ...
        {
            // 给ViewHolder设置布局文件
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.taskaccept_list_item, viewGroup, false);
            //设置点击效果
    ...
    public void onAttach(Activity activity) {
        ...
        System.out.println("AAAAAAAAAA____onAttach2");
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        System.out.println("AAAAAAAAAA____onCreate2");
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        System.out.println("AAAAAAAAAA____onActivityCreated2");
    }

    @Override
    public void onStart() {
        super.onStart();
        System.out.println("AAAAAAAAAA____onStart2");
    }

    @Override
    public void onResume() {
        super.onResume();
        System.out.println("AAAAAAAAAA____onResume2");
    }

    @Override
    public void onPause() {
        super.onPause();
        System.out.println("AAAAAAAAAA____onPause2");
    }

    @Override
    public void onStop() {
        super.onStop();
        System.out.println("AAAAAAAAAA____onStop2");
    }

    @Override
    public void onDestroyView() {
        super.onDestroyView();
        System.out.println("AAAAAAAAAA____onDestroyView2");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        System.out.println("AAAAAAAAAA____onDestroy2");
    }

    @Override
    public void onDetach() {
        super.onDetach();
        System.out.println("AAAAAAAAAA____onDetach2");
    }
}
