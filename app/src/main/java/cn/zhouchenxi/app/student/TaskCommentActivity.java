...
public class TaskCommentActivity extends AppCompatActivity implements  BGARefreshLayout.BGARefreshLayoutDelegate, BGAOnRVItemClickListener, BGAOnRVItemLongClickListener, BGAOnItemChildClickListener, BGAOnItemChildLongClickListener {
    ...
    public void loadTaskComment(final int mode)  {
        ...
        Observable<TaskCommentModel> loadTaskComment = service.loadTaskComment(Integer.parseInt(uid), varifyCode,tid,mode,flag);
        loadTaskComment.doOnNext(new Action1<TaskCommentModel>() {
    ...
    public void postTaskComment()  {
        Observable<PostCommentModel> postTaskComment = service.postTaskComment(
                Integer.parseInt(uid), varifyCode,tid,replyId,commentToUid,commentBox.getText().toString());
        postTaskComment.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
